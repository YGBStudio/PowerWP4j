...
public interface QueryParamEnum {
     ...
     *
     * <p>You need to have at least one "leading" (starting with '?') or main query parameter in your map.
     * This is the parameter that will be used to separate the query parameters from the rest of the URL
     * and avoid malformed requests.
     *
     * <p>It is up to you to create a separate class that contains such "leading"
     * parameters or use the same for all as long as both implement {@link QueryParamEnum}.
     * In either case this method will help you and throw an {@link IllegalArgumentException}
     * if you do not provide a single query parameter that starts with '?' with its value pair.
     *
     * @param wpRestQueriesMap <p>Map of query parameters and their values.
     * @return <p>String that can be used as a query string.
     */
